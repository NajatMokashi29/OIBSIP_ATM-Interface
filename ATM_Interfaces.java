...
class ATM {
    ...
    ATM() {
        ...
        amount = sc.nextInt();
        transaction_arr = new String[150];
        i = 0;
    }
    ...
    void transaction() {
        ...
        for (int k = 0; k < i; k++) {
            System.out.println(transaction_arr[k]);
        }
    }
    ...
    void withdraw() {
        ...
        if (w_amount % 100 == 0 && amount > w_amount && amount - w_amount >= 500) {
            ...
            transaction_arr[i] = new String(i + 1 + ")Withdraw amount:" + w_amount);
            i++;
        }
    ...
    void deposit() {
        ...
        transaction_arr[i] = new String(i + 1 + ")Deposited amount :" + d_amount);
        i++;
    }
    ...
    void transefer() {
        ...
        if (amount - 500 < t_amount) {
            ...
            transaction_arr[i] = new String(i + 1 + ")Transfer " + t_amount);
            i++;
        }
    }
